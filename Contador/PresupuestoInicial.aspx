<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PresupuestoInicial.aspx.cs" Inherits="Contador_PresupuestoInicial" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="row col l10 offset-l1 m10 offset-m1 s10 offset-s1">
            <asp:GridView EmptyDataText="Aún no cuenta con un presupuesto inicial" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="idPresupuesto" DataSourceID="SqlDataSource1">
                <Columns>
                    ...
                    <asp:BoundField DataField="matricula" DataFormatString="{0:0.00}" HeaderText="Matrícula" SortExpression="matricula" />

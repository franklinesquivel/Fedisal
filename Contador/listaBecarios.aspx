<%@ Page Language="C#" AutoEventWireup="true" CodeFile="listaBecarios.aspx.cs" Inherits="Contador_listaBecarios" %>
                    ...
                    <asp:GridView ID="GridView1" EmptyDataText="No hay becarios registrados" runat="server" AutoGenerateColumns="False" DataKeyNames="Código" DataSourceID="SqlDataSource1">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Presupuesto Inicial" SortExpression="idBecario">
                                <ItemTemplate>
                                    <asp:HyperLink NavigateUrl='<%# string.Concat("/Contador/Presupuestoinicial.aspx?id=", Eval("Código")) %>' ID="lblBeca" runat="server" CssClass="iconSee waves-effect" Text="Ver" />
                                </ItemTemplate>
                            </asp:TemplateField> 
                            <asp:TemplateField HeaderText="Historial Desembolsos" SortExpression="idBecario">
                                <ItemTemplate>
                                    <asp:HyperLink NavigateUrl='<%# string.Concat("/Contador/HistorialDesembolso.aspx?id=", Eval("Código")) %>' ID="lblBeca" runat="server" CssClass="iconSee waves-effect" Text="Ver" />
                                </ItemTemplate>
                            </asp:TemplateField> 
                        </Columns>
                    </asp:GridView>
